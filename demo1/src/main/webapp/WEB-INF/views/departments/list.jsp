...
<body>
    <div class="container">
        ...
        <a href="/departments/new" class="btn btn-success">Add New Department</a>
        ...
        <c:if test="${empty departments}">
            <p style="text-align: center; color: #666; margin-top: 30px;">No departments found. Click "Add New Department" to create one.</p>
        </c:if>
    </div>
</body>
</html>

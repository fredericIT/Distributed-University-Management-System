...
<body>
    <div class="container">
        ...
        <h1>
            <c:if test="${lecturer.id == null}">Add New Lecturer</c:if>
            <c:if test="${lecturer.id != null}">Edit Lecturer</c:if>
        </h1>
        
        <c:choose>
            <c:when test="${lecturer.id == null}">
                ...
                <select id="department" name="department.id" required>
                    ...
                    <c:forEach var="department" items="${departments}">
                        <option value="${department.id}" 
                                <c:if test="${lecturer.department.id == department.id}">selected</c:if>>
            ...
            <button type="submit" class="btn">
                <c:if test="${lecturer.id == null}">Save Lecturer</c:if>
                <c:if test="${lecturer.id != null}">Update Lecturer</c:if>
            </button>
